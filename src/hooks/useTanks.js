...
export const useLatestWaterLevel = (tankId, options = {}) => {
  return useQuery({
    queryKey: queryKeys.tanks?.waterLevel(tankId) || ['tanks', 'waterLevel', tankId],
...
export const useLatestWaterLevelGallons = (tankId, options = {}) => {
  return useQuery({
    queryKey: queryKeys.tanks?.waterLevelGallons(tankId) || ['tanks', 'waterLevelGallons', tankId],
...
export const useHourlyTankStatus = (customerId, startDate, endDate, options = {}) => {
  return useQuery({
    queryKey: queryKeys.tanks?.hourlyStatus(customerId, startDate, endDate) || ['tanks', 'hourlyStatus', customerId, startDate, endDate],
    queryFn: () => tankService.getHourlyTankStatus(customerId, startDate, endDate),
...
export const useRefreshTankData = (tankId) => {
  ...
  return useMutation({
    ...
    onSuccess: (data) => {
      ...
      queryClient.setQueryData(
        queryKeys.tanks?.waterLevelGallons(tankId) || ['tanks', 'waterLevelGallons', tankId],
