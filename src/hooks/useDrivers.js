...
export const useDriverDeliveryReport = (
  driverId,
  startDate,
  endDate,
  options = {}
  ...
  return useQuery({
    ...
    queryFn: () =>
      driverService.getDriverDeliveryReport(driverId, startDate, endDate),
...
export const useUpdateDriver = () => {
  ...
  return useMutation({
    mutationFn: ({ driverId, driverData }) =>
      driverService.updateDriver(driverId, driverData),
    onSuccess: (data, variables) => {
      // Invalidate and refetch drivers
      queryClient.invalidateQueries({ queryKey: queryKeys.drivers.all() });
      queryClient.invalidateQueries({
        queryKey: queryKeys.drivers.byId(variables.driverId),
      });
