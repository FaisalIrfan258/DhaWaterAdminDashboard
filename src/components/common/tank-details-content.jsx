                ...
                <div className="flex flex-col gap-4 w-full">
                  <div className="p-4 rounded-lg border border-white/20 bg-white/10">
                    ...
                    <p className="text-3xl font-bold text-white">
                      {waterLevelGallons.toLocaleString()}{" "}
                      <span className="text-xl text-white/80">gallons</span>
                    </p>
                  </div>
                  <div className="p-4 rounded-lg border border-white/20 bg-white/10">
                    <h3 className="text-lg font-semibold text-white/90 mb-1">
                    ...
                    <p className="text-3xl font-bold text-white">
                      {waterLevelFeet.toFixed(3)}{" "}
                      <span className="text-xl text-white/80">ft</span>
                    </p>
                  </div>
                </div>
              </CardContent>
                ...
                <CardContent className="space-y-6 p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="p-4 rounded-lg border border-white/20 bg-white/10">
                      ...
                      <p className="text-3xl font-bold text-white">
                        {gallonsPerFeet.toLocaleString(undefined, {
                      ...
                      <div className="flex-1 space-y-4">
                        <div className="flex justify-between items-center">
                          ...
                          <span className="font-bold text-white">
                            {totalCapacity.toLocaleString()} gallons
                          </span>
                        </div>
                        <div className="flex justify-between items-center">
                          <span className="font-medium text-white/90">
                          ...
                          <span className="font-bold text-white">
                            {waterLevelGallons.toLocaleString()} gallons
                          </span>
                        </div>
                        <div className="flex justify-between items-center">
                          <span className="font-medium text-white/90">
                          ...
                          <span className="font-bold text-white">
                            {(
                              totalCapacity - waterLevelGallons
                            ).toLocaleString()}{" "}
                            gallons
                          </span>
                        </div>
...
export default function TankDetails() {
  return (
    <Suspense
      fallback={<div className="p-6 text-center">Loading Tank Details...</div>}
    >
      <TankDetailsContent />
    </Suspense>
  );
