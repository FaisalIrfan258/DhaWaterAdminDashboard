...
export const WaterTank = ({ waterLevel }) => {
  return (
    <div className="w-48 h-64 bg-gradient-to-b from-cyan-100 to-blue-200 border-2 border-cyan-400 rounded-lg relative overflow-hidden">
      ...
      >
        <div className="absolute top-0 left-0 right-0 h-2 bg-cyan-300 opacity-30 animate-wave"></div>
        <div className="absolute top-1 left-0 right-0 h-2 bg-cyan-300 opacity-30 animate-wave-reverse"></div>
      </motion.div>
