...
const ReservoirStatus = () => {
  ...
  if (isLoading) {
    return <div className="text-center text-cyan-700">Loading...</div>;
  }
  ...
  return (
    <div className="p-6 bg-gradient-to-br from-cyan-50 to-blue-100 rounded-lg shadow-lg">
      ...
      <div className="bg-white p-6 rounded-xl shadow-md transform hover:scale-105 transition-transform duration-300">
        ...
        <div className="relative w-40 h-64 mx-auto bg-cyan-200 rounded-2xl overflow-hidden shadow-inner">
          <div
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <span className="text-lg font-bold text-white bg-gradient-to-r from-cyan-600 to-blue-600 rounded-full px-3 py-1 shadow-lg">
              {percentage}%
            </span>
          </div>
        </div>
