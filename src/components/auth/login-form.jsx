  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      >
        ...
        <TabsContent value="admin" className="mt-4">
          <p className="text-sm text-gray-500 mb-4">
            Sign in as an administrator to manage your assigned water supply
            facilities.
          </p>
        </TabsContent>
        <TabsContent value="superAdmin" className="mt-4">
          <p className="text-sm text-gray-500 mb-4">
            Sign in as a super administrator to access all system controls and
            management features.
          </p>
        </TabsContent>
      </Tabs>
      ...
      >
        {isLoading
          ? "Signing in..."
          : `Sign in as ${loginType === "admin" ? "Admin" : "Super Admin"}`}
      </Button>
    </form>
  );
}
